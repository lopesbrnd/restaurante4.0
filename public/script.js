...
let Garçom1= new Garcom("Gabriela")
let Garçom2= new Garcom("Marina")
let Garçom3= new Garcom("Bernado")
let Garçom4= new Garcom("Guilherme")

let garcons_restaurante =[Garçom1, Garçom2, Garçom3, Garçom4]

function gerar_garcom() {
    let select=document.getElementById("garcpm");
    garcons_restaurante.forEach(Garcom => {
